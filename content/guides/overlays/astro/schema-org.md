---
title: "Schema.org in Astro"
description: "Add machine-readable JSON-LD so search and AI systems understand entities. Framework notes for Astro."
...
In **Astro**, inject JSON-LD into the document head or early body from the server/static build so crawlers see it without executing client JS.
