---
title: "Core Web Vitals in React"
description: "Improve LCP, INP, and CLS for real-user experience and search signals. Framework notes for React."
...
In **React**, Core Web Vitals are usually won or lost in the initial HTML and the LCP media path. Prefer server-rendered or statically generated shells, and avoid shipping unnecessary client JS on marketing routes.
...
Use a Vite/plugin image pipeline or CDN transforms when available so the framework emits responsive `srcset` automatically.
