...
description: "Titles, descriptions, and document head tags that shape SERP and social quality. Framework notes for Next.js."
difficulty: beginner
tags:
  - title
  - description
...
**Next.js** should emit titles and descriptions in the initial HTML. Prefer `generateMetadata` / `metadata` export in the App Router so crawlers never depend on client hydration for head tags.
...
Wire these through `generateMetadata` / `metadata` export in the App Router.
